...
def test_ci_value_bound():
    ...
    a = LogCredibilityInterval(log_mean=1, log_variance=4, sample_size=4)
    assert a.get_variate('95%') == 2.571
    a = LogCredibilityInterval(log_mean=1, log_variance=4, sample_size=5)
    assert a.get_variate('95%') == 2.571
    a = LogCredibilityInterval(log_mean=1, log_variance=4, sample_size=6)
    assert a.get_variate('95%') == 2.571
    a = LogCredibilityInterval(log_mean=1, log_variance=4, sample_size=11)
    assert a.get_variate('95%') == 2.228
    a = LogCredibilityInterval(log_mean=1, log_variance=4, sample_size=16)
    assert a.get_variate('95%') == 2.131
    a = LogCredibilityInterval(log_mean=1, log_variance=4, sample_size=21)
    assert a.get_variate('95%') == 2.086
    a = LogCredibilityInterval(log_mean=1, log_variance=4, sample_size=26)
    assert a.get_variate('95%') == 2.060
    a = LogCredibilityInterval(log_mean=1, log_variance=4, sample_size=31)
    assert a.get_variate('95%') == 2.042
    a = LogCredibilityInterval(log_mean=1, log_variance=4, sample_size=32)
